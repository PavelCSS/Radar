...
function openPage(){var a=window.location.hash.replace("#",""),a=a||"true"!==localStorage.getItem("login")?a:"home";backBtnSwitch&&"home"!==a&&(backBtnSwitch=!1,document.addEventListener("backbutton",goBack,!1));switchMenu=!1;"login"===a&&(localStorage.removeItem("pageList"),localStorage.removeItem("login"),$("aside").remove());var b=localStorage.getItem("pageList"),b=b?JSON.parse(b):!1;if(a&&"undefined"!==typeof b[a])return goPage(a),!0;if("true"!==localStorage.getItem("login"))a="login";else if("undefined"===
typeof pagesList[a])return!1;pagesList[a]()}function showLoading(){$("html").addClass("loading")}function hideLoading(){$("html").removeClass("loading")};
