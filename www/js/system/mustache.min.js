...
c.length;return c};p.prototype.push=function(a){return new p(a,this)};p.prototype.lookup=function(a){var c=this.cache,b;if(a in c)b=c[a];else{for(var d=this,g,e;d;){if(0<a.indexOf("."))for(b=d.view,g=a.split("."),e=0;null!=b&&e<g.length;)b=b[g[e++]];else"object"==typeof d.view&&(b=d.view[a]);if(null!=b)break;d=d.parent}c[a]=b}n(b)&&(b=b.call(this.view));return b};s.prototype.clearCache=function(){this.cache={}};s.prototype.parse=function(a,c){var b=this.cache,d=b[a];null==d&&(d=b[a]=A(a,c));return d};
s.prototype.render=function(a,c,b){var d=this.parse(a);c=c instanceof p?c:new p(c);return this.renderTokens(d,c,b,a)};s.prototype.renderTokens=function(a,c,b,d){function g(a){return p.render(a,c,b)}for(var e="",p=this,l,f,t=0,s=a.length;t<s;++t)switch(l=a[t],l[0]){case "#":f=c.lookup(l[1]);if(!f)continue;if(x(f))for(var k=0,q=f.length;k<q;++k)e+=this.renderTokens(l[4],c.push(f[k]),b,d);else if("object"===typeof f||"string"===typeof f)e+=this.renderTokens(l[4],c.push(f),b,d);else if(n(f)){if("string"!==
typeof d)throw Error("Cannot use higher-order sections without the original template");f=f.call(c.view,d.slice(l[3],l[5]),g);null!=f&&(e+=f)}else e+=this.renderTokens(l[4],c,b,d);break;case "^":f=c.lookup(l[1]);if(!f||x(f)&&0===f.length)e+=this.renderTokens(l[4],c,b,d);break;case ">":if(!b)continue;f=n(b)?b(l[1]):b[l[1]];null!=f&&(e+=this.renderTokens(this.parse(f),c,b,f));break;case "&":f=c.lookup(l[1]);null!=f&&(e+=f);break;case "name":f=c.lookup(l[1]);null!=f&&(e+=m.escape(f));break;case "text":e+=
l[1]}return e};m.name="mustache.js";m.version="1.0.0";m.tags=["{{","}}"];var y=new s;m.clearCache=function(){return y.clearCache()};m.parse=function(a,c){return y.parse(a,c)};m.render=function(a,c,b){return y.render(a,c,b)};m.to_html=function(a,c,b,d){a=m.render(a,c,b);if(n(d))d(a);else return a};m.escape=function(a){return String(a).replace(/[&<>"'\/]/g,function(a){return K[a]})};m.Scanner=v;m.Context=p;m.Writer=s});
